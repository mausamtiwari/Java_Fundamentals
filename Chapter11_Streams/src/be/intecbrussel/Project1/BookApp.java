...
public class BookApp {
    ...
    private static Book getNewestBook(Book[] books) {   // Returns latest release date.
    ...
    private static void printYoungestWriter(Book[] books) {
    ...
    private static void printSortedByTitle(Book[] books) {
    ...
    private static void countBooksPerAuthor(Book[] books) {
        Arrays.stream(books)       // Converts array of Book object into stream.
    ...
    private static void printBooksReleasedIn2016(Book[] books) {
        Arrays.stream(books)                    // Converts array of Book object into stream.
